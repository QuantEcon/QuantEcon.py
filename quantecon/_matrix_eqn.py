...
def solve_discrete_riccati_system(Π, As, Bs, Cs, Qs, Rs, Ns, beta,
   ...
   # == Set up for iteration on Riccati equations system == #
    error = tolerance + 1
    if beta == 1.0:
        fail_msg = "Convergence failed after {} iterations. Note: When beta=1, the Riccati difference equation lacks strict contraction, leading to extremely slow convergence. Consider significantly increasing max_iter."
    else:
        fail_msg = "Convergence failed after {} iterations."
