...
class TestLQNash:
    ...
    def test_randomseed(self):
        ...
        a = np.array([[0.95, 0.], [0, 0.95]])
        b1 = np.array([0.95, 0.])
        b2 = np.array([0., 0.95])
        r1 = np.array([[-0.25, 0.], [0., 0.]])
        r2 = np.array([[0., 0.], [0., -0.25]])
        q1 = np.array([[-0.15]])
        q2 = np.array([[-0.15]])
        ...
        f1, f2, p1, p2 = nnash(
            a, b1, b2, r1, r2, q1, q2, 0, 0, 0, 0, 0, 0,
            tol=1e-8, max_iter=10000, random_state=rng1
        )

        f1_2, f2_2, p1_2, p2_2 = nnash(
            a, b1, b2, r1, r2, q1, q2, 0, 0, 0, 0, 0, 0,
            tol=1e-8, max_iter=10000, random_state=rng2
        )

        f1_3, f2_3, p1_3, p2_3 = nnash(
            a, b1, b2, r1, r2, q1, q2, 0, 0, 0, 0, 0, 0,
            tol=1e-8, max_iter=10000, random_state=rng1
        )
